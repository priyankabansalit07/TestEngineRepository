...
namespace TestEngine.Utility.Utils
{
    public class Common
    {
        ...
        #region "Read Language (Pass Parameter page)"
            ...
            if (xmlLang != null)
            {
                ...
                else if(page == "login")
                {
                    var language = (from tutorial in xmlLang.Descendants("language")
                                    ...
                                    select new
                                    {
                                        testpin = tutorial.Element("testpin").Value,
                                        lblpinInst=tutorial.Element("lblpinInst").Value,
                                        btnsubmit=tutorial.Element("btnsubmit").Value
                                    }).FirstOrDefault();

                    lmodel.testpin = language.testpin;
                    lmodel.btnsubmit = language.btnsubmit;
                    lmodel.lblpinInst = language.lblpinInst;
                }
            }
            else
            {
                ...
                {
                    lmodel.testpin = "Test Pin";
                    lmodel.btnsubmit = "Submit";
                    lmodel.lblpinInst = "Please enter the test pin and click the Submit button";
                }
            }
            return lmodel;
